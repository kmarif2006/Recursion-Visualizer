...
function App() {
  ...
  const [powerExp, setPowerExp] = useState(3);

  const handleGenerateTree = async () => {
    try {
      const data = await generateRecursionTree(functionName, inputValue, powerBase, powerExp);
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <Controls 
          ...
          powerBase={powerBase}
          setPowerBase={setPowerBase}
          powerExp={powerExp}
          setPowerExp={setPowerExp}
